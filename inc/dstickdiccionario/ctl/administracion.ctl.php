...
$script = <<<EOM
 ...
 $("#dtxtdiccionario").val(data.diccionario); $("#dtxttitulo").val(data.titulo);  });  }else{ 	alert("Debe seleccionar definicion primero.");	$("#cargando").hide(); $("#cargandodiv").hide(); return false; } });
