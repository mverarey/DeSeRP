<div class="box">
  ...
  <div class="box-body">
	...
	<table id="tbldatab0d48d5325dfbacbe15be19c115a681d8" data-toggle="table" data-url="/json/dstickproyecto/?joins=" data-pagination="true"
	...
	<tr>
		...
		<th data-field="FKidLiderProyecto" data-sortable="true" data-visible="true">LiderProyecto</th>
		<th data-field="FKidCategoria" data-sortable="true" data-visible="true">Categoría</th>
		<th data-field="FKidCliente" data-sortable="true" data-visible="true">Cliente</th>
		<th data-field="nombre" data-sortable="true" data-visible="true">Nombre</th>
		<th data-field="descripcion" data-sortable="true" data-visible="true">Descripción</th>
		<th data-field="fechaCreacion" data-sortable="true" data-visible="true">Fecha de Creación</th>
		<th data-field="fechaInicio" data-sortable="true" data-visible="true">Fecha de Inicio</th>
		<th data-field="fechaFin" data-sortable="true" data-visible="true">Fecha de Término</th>
	...
	<div id="toolbar-bootstrapTable" class="btn-group">
		...
		<a href='/xlsx/dstickproyecto/?joins=' class='btn btn-default'><i class='fa fa-download'></i> Exportar</a>
	</div>
    </div>
